...
<body class="bg-gray-50 font-['Inter']">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">CalsFine Admin</h1>
                        <p class="text-sm text-gray-500">Dashboard Management</p>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Selamat datang di panel admin CalsFine. Kelola pesanan dan menu dari sini.</p>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mb-4">Lihat dan kelola semua pesanan yang masuk</p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mb-4">Tambah, edit, atau hapus item menu</p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mb-4">Lihat laporan penjualan dan analitik</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-gray-600 text-sm">Pesanan yang baru masuk hari ini</p>
            </div>
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('home') }}" class="text-orange-600 hover:text-orange-700 font-medium text-sm flex items-center justify-center">
